...
namespace Utilities.CGTK
{
	public static partial class CGMath
	{
		...
		public static Vector3Int Lerp(Vector3Int from, Vector3Int to, float duration = 0f)
			=> Vector3.Lerp(from, to, duration).RoundedToVector3Int();
		
		public static Vector3Int LerpUnclamped(Vector3Int from, Vector3Int to, float duration = 0f)
			=> Vector3.LerpUnclamped(from, to, duration).RoundedToVector3Int();
		
		public static Vector3Int InverseLerp(Vector3Int from, Vector3Int to, float duration = 0f)
		{
		...
		public static Vector3Int Slerp(Vector3Int from, Vector3Int to, float duration = 0f)
			=> Vector3.Slerp(from, to, duration).RoundedToVector3Int();

		public static Vector3Int SlerpUnclamped(Vector3Int from, Vector3Int to, float duration = 0f)
			=> Vector3.SlerpUnclamped(from, to, duration).RoundedToVector3Int();
