    ...
    public static partial class CGMath
    {
        public struct Vector3d
        {
                ...
                double smoothTime, double maxSpeed, double deltaTime)
            {
                ...
                if (!(Vector3d.Dot(vector3_1 - current, vector3_4 - vector3_1) > 0.0)) return vector3_4;
            ...
            {
                return CGMath.Acos(CGMath.Clamp(Vector3d.Dot(from.normalized, to.normalized), -1d, 1d)) * 57.29578d;
            }
            ...
            {
                return new Vector3d(CGMath.Min(lhs.x, rhs.x), CGMath.Min(lhs.y, rhs.y), CGMath.Min(lhs.z, rhs.z));
            }
