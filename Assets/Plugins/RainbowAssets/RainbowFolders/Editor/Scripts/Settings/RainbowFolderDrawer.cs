...
namespace Borodar.RainbowFolders.Editor.Settings
{
    ...
    public class RainbowFolderDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            SerializedProperty folderKey = property.FindPropertyRelative("Key");
            SerializedProperty folderKeyType = property.FindPropertyRelative("Type");
            ...
            SerializedProperty iconRecursive = property.FindPropertyRelative("IsIconRecursive");

            SerializedProperty background = property.FindPropertyRelative("Background");
            SerializedProperty backgroundRecursive = property.FindPropertyRelative("IsBackgroundRecursive");
            ...
            KeyType typeSelected = (KeyType) Enum.GetValues(typeof(KeyType)).GetValue(folderKeyType.enumValueIndex);
