...
namespace Borodar.RainbowFolders.Editor
{
    public class RainbowFoldersPopup : DraggablePopupWindow
    {
        ...
        public void ShowWithParams(Vector2 inPosition, List<string> paths, int pathIndex)
        {
            ...
            float customIconHeight = (_currentFolder.IsIconCustom) ? LINE_HEIGHT * 2f : 0f;
            float customBackgroundHeight = (_currentFolder.IsBackgroundCustom) ? LINE_HEIGHT : 0f;
        ...
        {
            Texture2D icon = RainbowFoldersEditorUtility.GetSettingsButtonIcon();
        ...
        {
            Texture2D icon = RainbowFoldersEditorUtility.GetDeleteButtonIcon();
        ...
        private void ButtonApply(Rect rect)
        {
            ...
            for (int i = 0; i < _existingFolders.Length; i++)
            {
